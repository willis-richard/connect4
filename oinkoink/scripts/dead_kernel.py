...
import torch
boards = torch.load('/home/richard/Downloads/oinkoink_boards.pth').numpy()
values = torch.load('/home/richard/Downloads/oinkoink_values.pth').numpy()
...
from oinkoink.neural.nn_tf import Connect4Sequence
...
from oinkoink.neural.nn_tf import value_net as net
